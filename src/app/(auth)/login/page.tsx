        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-4">
            ...
            <div className="flex w-full max-w-sm flex-col gap-4">
                <Card className="w-full max-w-md rounded-2xl bg-(--color-midnight-950)/70 p-10 shadow-2xl backdrop-blur-lg border border-white/5">
                    <CardHeader>
                        <CardTitle className="text-center text-2xl font-semibold text-white">Welcome back.</CardTitle>
                    ...
                    <CardFooter>
                        <p className="w-full text-center text-sm text-muted-foreground text-white">
                            ...
                            <Link href="/signup" className="font-semibold underline-offset-4 hover:underline text-white">
                                Sign up
                            </Link>
                        </p>
                    </CardFooter>
